...
It was already possible to attach multiple PDF templates to a form. It is now possible to create multiple _email templates_ for a form. This allows you to send different emails to different recipients, with different content, and even with different attachments.
