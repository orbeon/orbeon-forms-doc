...
Before Orbeon Forms 2020.1, the cut/copy/paste operations were restricted to the currently running instance of Form Builder. This version of Orbeon Forms allows these operations between forms belonging to the same _user session_.
...
This release takes baby steps towards supporting _workflow_ features. The concept of _stage_ is introduced, and supported for all relational databases. It can be controlled with the following:
