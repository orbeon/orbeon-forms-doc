...
* **Angular component.** For details, see [Angular component](../form-runner/link-embed/angular-component.md) blog post.
* **React component.** For details, see [React component](../form-runner/link-embed/react-component.md) blog post.
...
Form Builder supports reusable _section templates_, which can be present in two separate _libraries_:
