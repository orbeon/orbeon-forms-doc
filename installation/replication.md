...
<figure><img src="../.gitbook/assets/replication.png" alt="Replication architecture" width="500"><figcaption><p>Replication architecture</p></figcaption></figure>
...
_NOTE: There isn't as single set of settings to replicate the Tomcat servlet session and Ehcache, as the two products use different libraries for replication. But the idea is that both configuration should behave as closely as possible from each other._
