...
_NOTE 1: Variables declared this way can only be used on binds within the XForms model where they are declared. Unlike top-level model variables, they are not visible in the view (see issue_ [_#309_](https://github.com/orbeon/orbeon-forms/issues/309)_)._

_NOTE 2: Up until Orbeon Forms 4.4, issue_ [_#152_](https://github.com/orbeon/orbeon-forms/issues/152) _prevented properly referring to named binds within bind iterations. This issue is fixed with Orbeon Forms 4.5._
...
* an expression on a given bind called below the _context bind_
