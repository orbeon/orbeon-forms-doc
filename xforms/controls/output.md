...
_NOTE: When using a_ `mediatype="text/html"`_, an HTML_ `<div>` _element will be generated by the XForms engine to hold the HTML data. As in HTML a_ `<div>` _cannot be embedded into a_ `<p>`_, if you have a_ `<xf:output mediatype="text/html">` _control, you should not put that control into a_ `<xh:p>`_._
