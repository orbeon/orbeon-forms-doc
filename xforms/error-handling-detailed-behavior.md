...
3. For the submission `instance` and `xxforms:instance` attributes
...
_NOTE: The fatal, non-cancelable XForms_ `xforms-compute-exception` _and_ `xforms-binding-exception` _are no longer dispatched by Orbeon Forms._
