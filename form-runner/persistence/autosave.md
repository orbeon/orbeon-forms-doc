...
See [Database Support](db-support.md) for the detail of which persistence layers and Orbeon Forms versions support the autosave feature.
...
When form data is autosaved, it creates _autosave drafts_:

* **Edit page:** Only a single autosave draft can be associated with the data's document id.
* **New page:** Multiple autosave drafts can be created.
...
_NOTE: Form Builder doesn't yet support autosave as of Orbeon Forms 2019.1._
...
When autosave is enabled and you are an authenticated user, form data is automatically saved as _drafts_ in the background as you enter and modify form data. This reduces the chance that you will lose data if something goes wrong and you haven't explicitly saved the data.
...
![Edit page](../../.gitbook/assets/autosave-open.png)
...
![New page, single draft](../../.gitbook/assets/autosave-new-single.png)

![New page, single draft](../../.gitbook/assets/autosave-new-multiple.png)
...
![Summary page with drafts only](../../.gitbook/assets/autosave-summary-drafts-only.png)
