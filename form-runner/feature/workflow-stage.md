...
Orbeon Forms has a number of features helping with workflows. One of them is the _workflow stage_.
...
* [The `set-workflow-stage()` action](../advanced/buttons-and-processes/actions-form-runner.md#set-workflow-stage)
