...
_NOTE: This is an advanced feature which requires XForms knowledge._
...
We can create a [custom button](buttons-and-processes/) that dispatches that event with the following properties:
