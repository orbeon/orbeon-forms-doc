...
* [\[SINCE Orbeon Forms 2025.1\]](../release-notes/orbeon-forms-2025.1.md) Review existing form definition in read-only mode: `/fr/orbeon/builder/view/$id` (see also [Reviewing a form definition](summary-page.md#reviewing-a-form-definition))
...
![New Form Dialog](../.gitbook/assets/new-form-dialog.png)
...
![New Form Dialog with Error](../.gitbook/assets/new-form-dialog-error.png)
