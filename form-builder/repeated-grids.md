...
![Repeating a single row](../.gitbook/assets/repeated-grid-single.png)
...
![Repeating multiple rows](../.gitbook/assets/repeated-grid-multiple.png)
...
![Repeated grids](../.gitbook/assets/repeated-grids.png)

In review mode and PDF mode, icons and menus disappear and the grid appears entirely readonly.

![Repeated grids in review mode](../.gitbook/assets/repeated-grids-view.png)

![Repeated grids in PDF mode](../.gitbook/assets/repeated-grids-pdf.png)

## Grid settings

Once a grid is inserted, you can edit its properties with the "Grid Settings" icon.

![Grid Settings](../.gitbook/assets/repeated-grid-settings-icon.png)

_NOTE: Since Orbeon Forms 4.8, these settings (correctly) apply to the entire grid. Previously, the grid's repeat headers did not hide properly for example when the grid was hidden. See issue_ [_#635_](https://github.com/orbeon/orbeon-forms/issues/635)_._

![Basic Settings and Formulas](../.gitbook/assets/grid-settings.png)
