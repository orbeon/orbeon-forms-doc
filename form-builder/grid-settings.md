...
![](../.gitbook/assets/grid-settings.png)

### Number of Grid Columns

\[SINCE Orbeon Forms 2020.1]

Orbeon Forms introduced a [12-column layout](form-area.md#the-12-column-layout) with Orbeon Forms 2017.2.
...
![Moving cell boundaries with a 12-column grid](../.gitbook/assets/grid-12-columns.png)

![Moving cell boundaries with a 24-column grid](../.gitbook/assets/grid-24-columns.png)
...
A default value can be set for all grids in the [Form Settings dialog](form-settings.md#form-options).
