...
In certain environments calling for high availability, or when one server running Orbeon Forms isn't enough to handle the load, you will want to deploy Orbeon Forms on multiple servers. Those servers are often called _cluster_.
...
![Load balancer, Orbeon Forms servers, and database server](../../.gitbook/assets/clustering.png)
