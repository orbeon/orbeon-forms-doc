...
Forms often participate in _workflows_, allowing collaboration between different users often having different tasks to perform depending on their role. Workflows are implemented using a combination of Orbeon Forms' capabilities:
...
* You can [enable or disable some of the buttons shown at the bottom of the form](../properties/form-runner-detail-page.md#hiding-and-disabling-buttons), say depending on the role of the user viewing the form.
...
![Permissions for pothole submission workflow](../../.gitbook/assets/workflows-pothole.png)
