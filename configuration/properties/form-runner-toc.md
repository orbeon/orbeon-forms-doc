...
![Table of contents on top](../../.gitbook/assets/toc-top.png)
...
![Table of contents on the left](../../.gitbook/assets/toc-left.png)

In PDF mode, the `left` position is not supported and the table of contents is always shown at the top.

![Table of contents on top in PDF files](../../.gitbook/assets/toc-top-pdf.png)
